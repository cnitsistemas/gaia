...
export const editFrequency = (data) => async (dispatch) => {
  return frequencyService
    .editFrequencyService(data)
    .then(
      (response) => {
        if (response) {
          if (response.success) {
...
export const getDataFrequency =
  ({ id }) =>
  (dispatch) => {
    return frequencyService
      .getDataFrequencyService(id)
      .then(
        (response) => {
          if (response) {
            dispatch({
