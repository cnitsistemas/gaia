        ...
        await login({ email: email, password: password }).then((response) => {
          if (response && !response.success) {
            showToast({
              ...
              description:
                response.message ||
                "Erro ao realizar o login do usuario. Usuário ou senha incorretos.",
              isClosable: false,
            });
            setIsLoading(false);
          } else {
    ...
    <View paddingH-40 style={styles.main} onLayout={onLayoutRootView}>
      <View style={styles.container}>
        <Animatable.Image
          ...
          source={require("../../../assets/logotipo-tecnogatt.png")}
          style={styles.img}
        />
        <Animatable.View
          delay={600}
        ...
        >
          <Text style={styles.welcomeText}>Seja muito bem-vindo!</Text>
          <Text style={styles.welcomeSubtext}>
            Faça o login para continuar.
          </Text>
        </Animatable.View>
        <Animatable.View delay={600} animation="fadeIn">
          <CustomInput
            placeholder={"Email"}
